      ...
      <div className="relative">
        ...
        <Card className="relative w-full max-w-md">
          <CardHeader className="text-center space-y-2">
            <CardTitle className="text-2xl font-bold">Welcome to CryptoBotics</CardTitle>
            <CardDescription>Login to manage your crypto Discord bots</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button
              className="w-full gradient-bg border-0 hover:opacity-90 flex items-center gap-2"
              size="lg"
            ...
            >
              ...
              <span>{isLoading ? "Logging in..." : "Login with Discord"}</span>
            </Button>
